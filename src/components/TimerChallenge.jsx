...
export default function TimerChallenge({titile, targetTimer}){
    ...
    function handleStart(){
        ...
        timer.current = setInterval(() => {     // it will return the pointer to the timer runnning
    ...
    <>
        ...
        <ResultModal ref={dialog} result='lost' targetTime={targetTimer} timeRemaining={timeRemaining}/>
